...
$(document).ready(function () {
    ...
    var room = {
        join: function (name) {
            this._username = name;
            var location = "ws://10.185.40.98:8030/camel-tweet";
    ...
    var refreshChart = function () {
        ...
        if (lastIndex == 0) {
            jQuery.getJSON('http://10.185.40.98:8081/charts', function (data) {
                globalData = data;
                lastIndex = 0;
                splitTheData();
            });
    ...
    jQuery("#IBRinput").change(function () {
        ...
        jQuery.getJSON('http://10.185.40.98:8081/getTweets/' + toFilter, function (data) {
            console.log("ok");
            $(this).val("");
        });
    });
